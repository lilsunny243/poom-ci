...
public class PropagateGraphVersionsTask extends AbstractGraphTask implements Callable<GraphTaskResult> {
    ...
    public PropagateGraphVersionsTask(List<RepositoryGraphDescriptor> descriptorList, Optional<String> branch, CommandHelper commandHelper, PoomCIPipelineAPIClient client, Workspace workspace, Notifier notifier) {
    ...
    public GraphTaskResult call() throws Exception {
        ...
        try {
            ...
            GraphWalker.WalkerTaskProvider walkerTaskProvider = (repository, context) -> new PropagateVersionsTask(repository, branch, context, commandHelper, client, workspace);
