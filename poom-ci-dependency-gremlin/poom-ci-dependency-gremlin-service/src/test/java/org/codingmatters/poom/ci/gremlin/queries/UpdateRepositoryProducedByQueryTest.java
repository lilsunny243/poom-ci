...
public class UpdateRepositoryProducedByQueryTest extends AbstractVertexQueryTest {

    @Test
    public void givenRepoHasNone__whenUpdatingWithNone__thenRepoHasNone() throws Exception {
        String repositoryId = "orga-repo10-branch";
        new UpdateRepositoryProducedByQuery(AnonymousTraversalSource.traversal().withRemote(this.gremlin.remoteConnection()))
                .update(repositoryId);

        List<Schema.ModuleSpec> actual = new ProducedByQuery<>(AnonymousTraversalSource.traversal().withRemote(this.gremlin.remoteConnection()),
    ...
    public void givenRepoHasNone__whenUpdatingWithOne__thenRepoHasThisOne() throws Exception {
        ...
        assertThat(actual, containsInAnyOrder(new Schema.ModuleSpec("group:module", "1")));
    }
