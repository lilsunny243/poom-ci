...
public class ProducedByQuery<T> extends VertexQuery<T> {
    public ProducedByQuery(GraphTraversalSource graph, Function<Map<String, List<VertexProperty>>, T> vertexMapper) {
